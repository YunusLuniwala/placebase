...
public class VideosDBAdapter {
	...
	public VideosDBAdapter(Context context) {
	 ...
	 *
	 */
	public VideosDBAdapter open() throws SQLException {
	 ...
	 */
	public long createVideo(int story, int uri) {
	 ...
	 */
	public boolean updateVideo(long rowId, int story, String uri) {
