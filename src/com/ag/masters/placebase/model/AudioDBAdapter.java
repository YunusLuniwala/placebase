...
public class AudioDBAdapter {
	// table name
		private static final String DATABASE_TABLE = "audio";
		// columns
		...
		public AudioDBAdapter(Context context) {
		 ...
		 */
		public long createAudio(int story, int uri) {
		 ...
		 */
		public boolean deleteAudio(long rowId) {
		 ...
		 * @throws SQLException
		 */
		public Cursor getAudio(long rowId) throws SQLException {
			Cursor mCursor = 
		 ...
		 */
		public boolean updateAudio(long rowId, int story, String uri) {
